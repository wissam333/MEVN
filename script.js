const HOST = "192.168.1.103"; // Replace with your actual host
...
// Function to fetch and display products (for product page)
async function fetchAndDisplayProducts() {
  try {
    const response = await fetch(
      `http://${HOST}:5000/api/products?page=1&pageSize=4`
    );
